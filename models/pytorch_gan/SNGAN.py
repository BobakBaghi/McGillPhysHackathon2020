"""Spctral Normalization GAN adopted from:
https://github.com/christiancosgrove/pytorch-spectral-normalization-gan.git

Use DCGAN structure (instead of ResNet).
"""
...
class Generator(nn.Module):
    """Input random tensors with z_dim latent dimension.
    Output tensor with size [n_channels, 32, 32]."""
    def __init__(self, z_dim, n_channels):
        ...
        self.model = nn.Sequential(
            ...
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.ConvTranspose2d(64, n_channels, 3, stride=1, padding=(1,1)),
            nn.Tanh())
